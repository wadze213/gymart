...
import 'package:sayanclub/screens/workOutCompleteScreen.dart';
...
class ExcerciseStepFourScreen extends StatefulWidget {
  const ExcerciseStepFourScreen({Key? key}) : super(key: key);

  @override
  _ExcerciseStepFourScreenState createState() =>
      _ExcerciseStepFourScreenState();
}

class _ExcerciseStepFourScreenState extends State<ExcerciseStepFourScreen> {
                ...
                Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                        ...
                        child: CustomButton(TextConst.finishWorkOutText)),
                  ),
                ])
              ],
            ),
